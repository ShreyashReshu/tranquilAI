...
const Vision = () => {
  return (
    <section id="vision" className="py-20 bg-gradient-to-r from-purple-100/70 to-blue-100/70 rounded-3xl">
      <div className="max-w-5xl mx-auto text-center px-4">
        <h2 className="text-3xl md:text-5xl font-bold mb-8 text-primary-purple animate-fade-in">Our Vision</h2>
        <Card className="border-none shadow-xl bg-white/80 backdrop-blur-sm hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-1">
